...
>) {
  ...
  return (
    <Tag
      ...
      className={cn(
        `relative flex rounded-full border-[${borderWidth}px] content-center bg-black/20 hover:bg-black/10 transition duration-500 dark:bg-white/20 items-center h-min justify-center overflow-visible p-px w-fit`,
        containerClassName
      )}
      {...props}
    >
      ...
      {/* Background inner panel adjusted by border width */}
      <div
        className={`bg-black absolute z-1 flex-none inset-[${borderWidth}px] rounded-[inherit]`}
      />
    </Tag>
  );
}
