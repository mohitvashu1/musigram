...
export const Spotlight = ({
  className = "",
  color = "hsla(150, 100%, 50%, 0.4)", // default green glow
  translateY = -350,
  width = 560,
  height = 1380,
  smallWidth = 240,
  ...
  const gradientFirst = `radial-gradient(68.54% 68.72% at 55.02% 31.46%, ${color} 0%, transparent 80%)`;
  const gradientSecond = `radial-gradient(50% 50% at 50% 50%, ${color} 0%, transparent 100%)`;
  const gradientThird = `radial-gradient(50% 50% at 50% 50%, ${color} 0%, transparent 80%)`;
